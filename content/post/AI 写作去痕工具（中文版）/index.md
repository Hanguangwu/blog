---
title: AI 写作去痕工具（中文版）
description: 本文介绍 AI 去 AI 化工具 Humanizer-zh 的使用说明。
date: 2026-02-28T12:34:25-08:00
draft: false
categories:
- AI
tags:
...
使用Reddit输入框很难输入——，也很难输出简体中文的弯体引号“”，于是便有了[AI杀死了破折号，也绞杀了语文。](https://mp.weixin.qq.com/s/s7OumZ8EX3_eBLTT9_cmdw?clicktime=1751640158&enterid=1751640158&scene=90&subscene=236&xtrack=1)这篇文章。我修改了[op7418/Humanizer-zh](https://github.com/op7418/Humanizer-zh)中相关的内容，因为破折号和弯角引号的部分不适合简体中文。本项目中的SKILL.md文件中提到了这一点：中文通常使用中文引号（「」或""），此模式在中文中表现为英文引号的使用。

Humanizer-zh 是 Humanizer 的中文汉化版本，旨在减少文本中 AI 生成的痕迹。它并非用于“欺骗” AI 检测器，而是为了真正提升写作质量，使文字更接近人类的自然表达。最佳的“去 AI 化”方式是让文本体现真实的人类思考和语气。

此工具可集成到写作工具 NoteGen 中使用，NoteGen 是一款跨平台的 Markdown AI Agent 笔记软件，项目地址为 [NoteGen——一款跨平台的 Markdown AI Agent 笔记软件](https://github.com/codexu/note-gen)。
