---
title: 美国PhD申请指南
description: 本文介绍一些关于美国PhD申请的建议。
...
本文来自于 GitHub 仓库：**[binhu02/Collection-of-advice-for-PhD-application](https://github.com/binhu02/Collection-of-advice-for-PhD-application)**
...
- **[Undergrad to PhD, or not - advice for undergrads interested in research](https://nlp.stanford.edu//~johnhew//undergrad-researchers.html)** -- John Hewitt
  ...
  （这篇建议给出了不同的途径来探索PhD是否适合自己，以及本科四年里可以准备什么。）
...
约翰霍普金斯大学语言语音处理中心的申请人指南，在 essays 章节列举了应该在文书中包含哪些内容。
...
[**Resume vs. Curriculum Vitae: What's the Difference?**](https://icc.ucdavis.edu/materials/resume/resumecv) -- UC Davis

答案是与用途有关。CV偏重于学术，常囊括学术经历的完整列表。Resume偏重于工作技能，长度有限制。所以在申请PhD项目的时候要准备的是CV。
...
需要会使用Latex，用于制作排版精美的CV。

### Word格式的CV模板

[**General CV Template.docx**](https://gradcareers.nd.edu/assets/345420/overall_cv_template.docx) -- U of Notre Dame

圣母大学提供的一个排版美观且正式的Word格式的CV模板。
...
- **[Hugo Academic](https://themes.gohugo.io/themes/starter-hugo-academic/)** [^1]
...
一个很大的，收集给现PhD学生的建议的仓库，包括做助教、申请奖学金等。也有一些给PhD申请者的建议。

[^1]: 本网站使用这个模板。需要go lang的版本不高于1.16。
