---
title: MoE 架构解析
description: 本文介绍 MoE 架构。
date: 2026-03-24T12:34:25-08:00
draft: false
categories:
- AI
- DataWhale
...
在这个目标函数中，系统倾向于**“赢家通吃”**。当某个专家 $\mathbf{E}_i$ 的输出非常接近目标 $\mathbf{y}$ 时（即误差项 $|| \mathbf{y} - \mathbf{E}_i ||^2$ 很小），指数项 $e^{-\dots}$ 会变得很大。为了最小化总 Loss，门控网络会倾向于显著增加这个“表现好”的专家的权重 $p_i$，而忽略其他专家。这一机制实现了**权重的解耦**。误差反向传播时，只有被选中的“胜出者”和门控网络的权重会被更新，其他专家几乎不受影响。**有效缓解了**任务间的干扰，实现了“让专业的人干专业的事”。
...
<p align="center">
  <img src="https://cdn.jsdelivr.net/gh/Hanguangwu/MyImageBed01/img/6_2_1.png" width="70%" alt="LSTM + MoE 架构图" />
  <br />
...
-   **引入噪声的稀疏门控**：
    ...
    <p align="center">
       <img src="https://cdn.jsdelivr.net/gh/Hanguangwu/MyImageBed01/img/6_2_2.png" width="50%" alt="模型容量与效果对比图" />
       <br />
...
<p align="center">
  <img src="https://cdn.jsdelivr.net/gh/Hanguangwu/MyImageBed01/img/6_2_3.png" width="80%" alt="GShard MoE Transformer Encoder 架构图" />
  <br />
...
<p align="center">
  <img src="https://cdn.jsdelivr.net/gh/Hanguangwu/MyImageBed01/img/6_2_4.png" width="80%" alt="Switch Transformer Encoder 架构图" />
  <br />
...
<p align="center">
  <img src="https://cdn.jsdelivr.net/gh/Hanguangwu/MyImageBed01/img/6_2_5.png" width="90%" alt="Token Routing Dynamics" />
  <br />
...
<p align="center">
  <img src="https://cdn.jsdelivr.net/gh/Hanguangwu/MyImageBed01/img/6_2_6.png" width="40%" alt="GLaM 模型架构图" />
  <br />
...
<p align="center">
  <img src="https://cdn.jsdelivr.net/gh/Hanguangwu/MyImageBed01/img/6_2_7.png" width="100%" alt="GLaM 与 GPT-3 性能与成本对比" />
  <br />
...
-   **路由机制**：每一层包含 **8 个专家**（Experts），采用标准的 **Top-2 Routing** 策略。如图 6-10 所示，每个输入 Token 会被 Router 网络分配给 8 个专家中的 2 个，这两个专家的输出经过加权求和后作为该层的最终输出。这种机制巧妙地在增加模型容量（更多专家）的同时，保持了极低的推理成本（只激活 2 个）。
    ...
    <p align="center">
      <img src="https://cdn.jsdelivr.net/gh/Hanguangwu/MyImageBed01/img/6_2_8.png" width="90%" alt="Mixture of Experts Layer" />
      <br />
...
-   **长上下文能力**：Mistral 8x7B 支持 **32k** 的上下文长度，并且在长文本信息检索（Passkey Retrieval）任务中表现出了 100% 的召回率，证明了 MoE 架构在处理长序列时依然稳健。
    ...
    <p align="center">
      <img src="https://cdn.jsdelivr.net/gh/Hanguangwu/MyImageBed01/img/6_2_9.png" width="90%" alt="Mistral 8x7B 性能对比" />
      <br />
...
<p align="center">
  <img src="https://cdn.jsdelivr.net/gh/Hanguangwu/MyImageBed01/img/6_2_10.png" width="90%" alt="Mistral 8x7B 路由专家分布" />
  <br />
...
<p align="center">
  <img src="https://cdn.jsdelivr.net/gh/Hanguangwu/MyImageBed01/img/6_2_11.png" width="80%" alt="DeepSeekMoE 架构图" />
  <br />
...
<p align="center">
  <img src="https://cdn.jsdelivr.net/gh/Hanguangwu/MyImageBed01/img/6_2_12.png" width="80%" alt="DeepSeek-R1 性能对比" />
  <br />
...
<p align="center">
  <img src="https://cdn.jsdelivr.net/gh/Hanguangwu/MyImageBed01/img/6_2_13.svg" width="40%" alt="Llama2 + MoE 架构图" />
  <br />
