---
title: 多模态向量数据库——以Milvus为例
description: 本文主要介绍多模态向量数据库。
date: 2026-04-02T22:40:25-08:00
draft: false
categories:
- AI
- DataWhale
...
![Schema 设计剖析](https://cdn.jsdelivr.net/gh/Hanguangwu/MyImageBed01/img/3_4_1.webp)
...
![Milvus 索引结构与工作原理](https://cdn.jsdelivr.net/gh/Hanguangwu/MyImageBed01/img/3_4_2.webp)
...
![检索结果可视化](https://cdn.jsdelivr.net/gh/Hanguangwu/MyImageBed01/img/3_4_3.png)
