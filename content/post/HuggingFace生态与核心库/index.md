---
title: Hugging Face 生态与核心库
description: 本文介绍 Hugging Face 生态与核心库。
date: 2026-03-23T15:34:25-08:00
draft: false
categories:
- AI
- DataWhale
...
<div align="center">
  <img src="https://cdn.jsdelivr.net/gh/Hanguangwu/MyImageBed01/img/5_4_1.png" width="90%" alt="Hugging Face 官网" />
...
- 尝试将之前实现的文本分类模型，从基于 `Word2Vec` 和 `LSTM` 的结构，迁移为使用 `BERT` 模型进行微调。对比分析两者在模型构建、训练流程以及最终性能上的异同。（可以参考[微调 BERT 模型进行文本分类](https://github.com/datawhalechina/base-nlp/blob/main/docs/chapter7/01_text_classification.md)）
