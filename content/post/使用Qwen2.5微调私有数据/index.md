---
title: 使用 Qwen2.5 微调私有数据
description: 本文介绍使用 Qwen2.5 微调私有数据的过程。
date: 2026-03-25T22:39:25-08:00
draft: false
categories:
- AI
- DataWhale
...
<p align="center">
  <img src="https://cdn.jsdelivr.net/gh/Hanguangwu/MyImageBed01/img/11_4_1.png" width="90%" alt="Qwen系列模型性能随预训练数据量增长图" />
  <br />
...
<p align="center">
  <img src="https://cdn.jsdelivr.net/gh/Hanguangwu/MyImageBed01/img/11_4_2.svg" width="70%" alt="技术选型路径" />
  <br />
