---
title: 向量数据库简介——以FAISS为例
description: 本文主要介绍向量数据库。
date: 2026-04-02T21:40:25-08:00
draft: false
categories:
- AI
- DataWhale
...
![向量数据库分类图](https://cdn.jsdelivr.net/gh/Hanguangwu/MyImageBed01/img/3_3_1.webp)
...
1. LlamaIndex 默认会将数据存储为透明可读的JSON格式，运行[03_llamaindex_vector.py](https://github.com/datawhalechina/all-in-rag/blob/main/code/C3/03_llamaindex_vector.py)文件，查看保存的json文件内容。
2. 新建一个代码文件实现对 LlamaIndex 存储数据的加载和相似性搜索。